/***************************************************************************
 * a symbol stub
 * derived from gpl2 code from Michael Margraf
 ***************************************************************************/
...
#include <qucs/dispatcher.h>

namespace{

class INTERFACE MOSFET : public SYMBOL {
public:
  MOSFET();
 ~MOSFET() {};
  Component* newOne();
...
private: // overrides
  // this is a draft
  std::string component_type { return "tbd"; }
  std::string source { return "tbd.va"; }
...
// incomplete
qucs_dispatcher::install d("TBD", &m);
